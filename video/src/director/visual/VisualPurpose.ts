// Every visual has a job. Finance now has documentary asset choices, not only
// animated money graphics.
...
export const MODULE_BY_PURPOSE: Record<VisualPurpose, { vox: string[]; finance: string[] }> = {
  CLAIM: { vox: ["kinetic", "stat"], finance: ["statFinance", "archive", "coinDrop"] },
  CONTRADICT: { vox: ["compare", "kinetic", "doodle"], finance: ["compareFinance", "archive", "investChart"] },
