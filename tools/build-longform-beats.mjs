...
const BEATS = [
  ...
  { name: "A TEN-YEAR WAR", module: "footage", text: "A WAR THAT LASTED TEN YEARS", purpose: "explain", question: "Why the name Iliad?", reveal: "Somebody inside Amazon saw a path that famously would not end — and they kept it.", emotion: "tension", camera: "settle", music: "quiet", silence: "none", caption: "EMPHASIS", revealMode: "SEQUENTIAL", from: "They named it after Homer's epic", to: "named it, and they kept it", cut: "lcut", footage: "antique book pages, library stacks, epic manuscript" },
  { name: "SEP 25, 2025", module: "evidence", text: "SEP 25, 2025", purpose: "proof", question: "How did the case end?", reveal: "Mid-trial, Amazon settled.", emotion: "surprise", camera: "settle", music: "quiet", silence: "pre", caption: "EMPHASIS", revealMode: "SEQUENTIAL", from: "On the twenty-fifth of September", to: "Amazon settled", footage: "federal courthouse, judge's gavel, settlement document" },
