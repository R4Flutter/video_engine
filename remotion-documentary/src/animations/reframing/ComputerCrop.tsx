...
const COMPUTER_REGION = { x: 0.1, y: 0.2, w: 0.8, h: 0.6 };

/**
 * ComputerCrop — wide-ish center crop, slightly upper. Default region is tuned
 * for the screen area of a laptop or monitor shot.
 */
export const ComputerCrop: React.FC<BaseEffectProps & { config?: any }> = ({
  image,
  children,
  durationInFrames = 90,
  delay = 0,
  ...
  const region = { ...COMPUTER_REGION, ...(config?.region || {}) };
