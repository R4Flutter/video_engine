...
const OBJECT_REGION = { x: 0.2, y: 0.25, w: 0.6, h: 0.5 };

/**
 * ObjectCrop — center-stage object framing. Default region is a generous center
 * crop, good for products, hero objects, mid-size artifacts.
 */
export const ObjectCrop: React.FC<BaseEffectProps & { config?: any }> = ({
  image,
  children,
  durationInFrames = 90,
  delay = 0,
  ...
  const region = { ...OBJECT_REGION, ...(config?.region || {}) };
