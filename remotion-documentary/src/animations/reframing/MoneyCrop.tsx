...
const MONEY_REGION = { x: 0.15, y: 0.3, w: 0.7, h: 0.4 };

/**
 * MoneyCrop — horizontal center crop, slightly low (where bills/coins usually sit).
 * Use for currency, totals, financial artifacts.
 */
export const MoneyCrop: React.FC<BaseEffectProps & { config?: any }> = ({
  image,
  children,
  durationInFrames = 90,
  delay = 0,
  ...
  const region = { ...MONEY_REGION, ...(config?.region || {}) };
