...
export const revenueCounter: React.FC<RevenueCounterProps> = ({ image, children, durationInFrames = 45, delay = 0, intensity = 1, style, className, config }) => {
  ...
  const { from = 0, to = 5000000, prefix = "$", suffix = "+", decimals = 2, fontSize = 32, color = "#10b981" } = config;
