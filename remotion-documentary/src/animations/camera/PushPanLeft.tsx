...
/**
 * PushPanLeft — PushIn (scale 1 → 1.15) + PanLeft (-width × 0.1) simultaneously.
 * Compound move. "Leaning in while looking left."
 */
export const PushPanLeft: React.FC<BaseEffectProps & { config?: any }> = ({
  image,
  children,
  durationInFrames = 90,
  delay = 0,
