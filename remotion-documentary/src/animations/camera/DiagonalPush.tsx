...
/**
 * DiagonalPush — PushIn + DiagonalPan (down-left). Scale 1 → 1.15,
 * translate(-width × 0.1, +height × 0.1). Punchy "into the action" move.
 */
export const DiagonalPush: React.FC<BaseEffectProps & { config?: any }> = ({
  image,
  children,
  durationInFrames = 90,
  delay = 0,
