...
/**
 * PullPan — PullOut (scale 1.15 → 1.0) + PanRight (+width × 0.1) simultaneously.
 * "Stepping back while looking right." Good for revealing broader context.
 */
export const PullPan: React.FC<BaseEffectProps & { config?: any }> = ({
  image,
  children,
  durationInFrames = 90,
  delay = 0,
