...
import {ScriptEpisodeComposition} from "./compositions/ScriptEpisodeComposition";
...
export const RemotionRoot: React.FC = () => {
  ...
  return <>
    ...
    <Composition id="ScriptEpisode" component={ScriptEpisodeComposition} durationInFrames={900} fps={30} width={1920} height={1080}/>
  </>;
};
